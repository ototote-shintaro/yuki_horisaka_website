			...
			<div className='pt-2 flex justify-center gap-12'>
				<div className='flex flex-col'>
					...
					<p className='mt-2'>
						...
						バイオリンを専門にクラシック音楽を学びながら、学生時代よりシンガーソングライター・ヴォーカリストとして府内のライブハウスに出演。<br />
						上京後、ヴォーカリスト・バイオリニストとして東京を中心に活動している。<br /><br />
						ソロ活動以外にバイオリンでのサポートや田中慎太郎との「静かの基地」、身体表現と演奏の即興を主体としたグループ「満月カルテット」などでも活動。<br /><br />
					</p>
				</div>
				<Image className='m-auto py-4 md:max-w-2xl md:max-h-2xl'
					src='/prof.jpg'
					alt=''
					width={780}
					height={300}
